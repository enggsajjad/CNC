...
{
    PLX_FLAG_PORT_NT_LINK_1     = 63,   // Port bit for NT Link port 0
    PLX_FLAG_PORT_NT_LINK_0     = 62,   // Port bit for NT Link port 1
    PLX_FLAG_PORT_NT_VIRTUAL_1  = 61,   // Port bit for NT Virtual port 0
    PLX_FLAG_PORT_NT_VIRTUAL_0  = 60,   // Port bit for NT Virtual port 1
    PLX_FLAG_PORT_NT_DS_P2P     = 59,   // Port bit for NT DS P2P port (Virtual)
    PLX_FLAG_PORT_DMA_RAM       = 58,   // Port bit for DMA RAM
    PLX_FLAG_PORT_DMA_3         = 57,   // Port bit for DMA channel 3
    PLX_FLAG_PORT_DMA_2         = 56,   // Port bit for DMA channel 2
    PLX_FLAG_PORT_DMA_1         = 55,   // Port bit for DMA channel 1
    PLX_FLAG_PORT_DMA_0         = 54    // Port bit for DMA channel 0 or Function 1 (all 4 channels)
} PLX_FLAG_PORT;
